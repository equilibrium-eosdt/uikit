...
function PersonNegativeIcon(props: IconProps) {
  return (
    <svg
      {...composeProps(props)}
      viewBox="0 0 48 48"
    ...
    >
      <g clip-path="url(#clip0_3181_59177)">
        <mask
          id="mask0_3181_59177"
...
export default PersonNegativeIcon;
